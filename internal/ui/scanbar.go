...
// along a track. The build disables fyne.Animation (no_animations), which would
// freeze ProgressBarInfinite, so this animates itself with a ticker and Refresh
...
// CreateRenderer wires the track and sweeping fill.
