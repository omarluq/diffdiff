...
import (
	...
	"github.com/omarluq/diffdiff/internal/config"
)
...
func newConfigShowCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			envKeys := upperEnvKeys("DIFFDIFF", entries)
...
// upperEnvKeys returns config keys uppercased with a given prefix (e.g. "DIFFDIFF_APP_NAME").
