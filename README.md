![diffdiff banner](banner.png)

<p align="center">
  <a href="https://pkg.go.dev/github.com/omarluq/diffdiff"><img src="https://img.shields.io/badge/reference-007d9c?style=flat&labelColor=24292e&logo=go&logoColor=white" alt="Go Reference"></a>
  ...
  <a href="https://goreportcard.com/report/github.com/omarluq/diffdiff"><img src="https://img.shields.io/badge/report-A%2B-00ADD8?style=flat&labelColor=24292e&logo=go&logoColor=white" alt="Go Report Card"></a>
  <br/>
...
├── cmd/diffdiff/            # CLI entrypoint and commands
...
Entry point (`cmd/diffdiff/main.go`):
...
2. Environment variables prefixed with `DIFFDIFF_` (e.g. `DIFFDIFF_APP_NAME`, `DIFFDIFF_LOGGING_LEVEL`)
3. `config.yaml` in the current directory
4. `$HOME/.config/diffdiff/config.yaml`
...
```bash
diffdiff config show       # Display all resolved config values
diffdiff config validate   # Check config is valid
```
